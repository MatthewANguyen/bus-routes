...
/**
 * An activity representing a single route detail screen.
 */
public class RouteDetailActivity extends AppCompatActivity {

    // SongItem includes the song title and detail.
    public RouteUtility.Route mRoute;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRoute = RouteUtility.ROUTE_ITEM.get
                (getIntent().getIntExtra(RouteUtility.ROUTE_ID_KEY, 0));
        // Show the detail information in a TextView.
        if (savedInstanceState == null) {
            int selectedSong = getIntent().getIntExtra(RouteUtility.ROUTE_ID_KEY, 0);
            RouteDetailFragment fragment = RouteDetailFragment.newInstance(selectedSong);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            NavUtils.navigateUpTo(this, new Intent(this, RouteActivity.class));
            return true;
        }
